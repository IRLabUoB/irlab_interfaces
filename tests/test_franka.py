...
if __name__ == '__main__':
    ...
    r = FrankaRobot(reset_frames = True) # handle to use methods from FrankaRobot class
    ...
    kin = r._kinematics # to test the kinematics (not required, can directly query kinematics using  methods in FrankaRobot)
