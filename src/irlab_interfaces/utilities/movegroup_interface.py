...
class RobotMoveGroupInterface:

    def __init__(self, movegroup_name, default_ee):
        """
        movegroup_name: name of movegroup 
        default_ee: frame to be used as default end-effector (should be valid tf frame from URDF)
        """
        ...
        self._arm_group = moveit_commander.MoveGroupCommander(movegroup_name)
        ...
        self._arm_group.set_end_effector_link(default_ee)
